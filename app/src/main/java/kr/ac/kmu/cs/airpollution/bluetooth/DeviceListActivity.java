...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> pairedDevicesAdapter = new ArrayAdapter<String>(this, R.layout.list_device_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.list_device_name);
