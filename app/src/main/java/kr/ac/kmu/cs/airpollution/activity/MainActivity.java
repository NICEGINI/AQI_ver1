...
//                         sw_BT.setChecked(true);
    ...
    public String makeJSON2(String email,String recTime,String devMAC){
    ...
    public void reqConnect(String URL,String email,String recTime,String devMAC) {
        ...
        String json = makeJSON2(email,recTime,MAC);
        // Initialize  AsyncLogin() class with email and password
        new AsyncLogin().execute(URL,json);
    }
...
//                        .appendQueryParameter("recTime", params[2])
//                        .appendQueryParameter("devMAC", params[3]);
